...
from .fd_clibrary import internal_library
...
AFD_FSDK_InitialFaceEngine = internal_library.AFD_FSDK_InitialFaceEngine
AFD_FSDK_UninitialFaceEngine = internal_library.AFD_FSDK_UninitialFaceEngine
AFD_FSDK_StillImageFaceDetection = internal_library.AFD_FSDK_StillImageFaceDetection
AFD_FSDK_GetVersion = internal_library.AFD_FSDK_GetVersion
